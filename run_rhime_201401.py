...
def inputs():
    ...
    flux_dict = {"species": "co2", 
                 "domain": "EUROPE",
                 "source": ["ff-edgar-2hr","gpp-jules-2hr", "rtot-jules-2hr"], 
                 "start_date": "2014-01-01",
                 "end_date": "2014-02-01",
                 "store": "user",
                 "flux_sf": {"ff-edgar-2hr": 1.0, 
                             "gpp-jules-2hr": 1.0,
                             "rtot-jules-2hr": 1.0,
                            }, 
                 "sector_dict": {"fossil": "ff-edgar-2hr",
                                 "gee": "gpp-jules-2hr",
                                 "rtot": "rtot-jules-2hr",
                                },
                }
    ...
    # MCMC dict
    mcmc_inputs_dict = {"xprior": {"ff-edgar-2hr": {"pdf": "truncatednormal", "mu": 1.2, "sigma": 1.2, "lower":0.0},
                                   "gpp-jules-2hr": {"pdf": "truncatednormal", "mu": 1.0, "sigma": 2.0, "lower": 0.0},
                                   "rtot-jules-2hr": {"pdf": "truncatednormal", "mu": 1.0, "sigma": 2.0, "lower":0.0},
                                  },
